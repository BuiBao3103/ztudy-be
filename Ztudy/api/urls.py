...
urlpatterns = [
    ...
    path('api/v1/users/<int:pk>/',
         views.UserRetrieveUpdateDestroy.as_view(), name='user-view-detail'),
    path('api/v1/users/<int:pk>/upload-avatar/',
         views.UploadAvatarView.as_view(), name='upload-avatar'),
    path('api/v1/users/<int:pk>/check-preferences/', views.CheckUserPreferences.as_view(),
         name='check-user-preferences'),
    path('api/v1/users/<int:pk>/add-interests/',
         views.AddUserInterest.as_view(), name='add-user-interests'),
    ...
    path('api/v1/motivational-quotes/random-quote/',
         views.RandomMotivationalQuoteView.as_view(), name='random-quote'),

    # Background Video URLs
    path('api/v1/background-videos/', views.BackgroundVideoListCreate.as_view(),
    ...
    # Session Goal URLs
    path('api/v1/session-goals/', views.SessionGoalListCreate.as_view(),
    ...
    # Stats URLs
    path('api/v1/stats/study-time/',
         views.StudyTimeStatsView.as_view(), name='study-time-stats'),
    path('api/v1/stats/study-time-chart/',
         views.StudyTimeChartView.as_view(), name='study-time-chart'),
